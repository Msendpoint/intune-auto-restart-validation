<#
.SYNOPSIS
    One-click installer and launcher for Intune Auto-Restart Validation and Remediation
...
Write-Host "    Intune Auto-Restart Validation and Remediation" -ForegroundColor Cyan
...
$mainScript = Join-Path $scriptDir "scripts/intune-auto-restart-validation.ps1"
